...
namespace OSA.Backend.CharacterApi.Client
{
    public class CharacterApiClientService : ICharacterApiClientService
    {
        ...
        {
            return await _httpClient.GetFromJsonAsync<IEnumerable<StarTrekCharacterDto>>("character");
        }
        ...
        public async Task<StarTrekCharacterDto?> GetCharacterAsync(int id)
        {
            ...
            {
                return await response.Content.ReadFromJsonAsync<StarTrekCharacterDto>();
            }
